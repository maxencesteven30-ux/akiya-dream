...
export const QUESTION_REGISTRY: QuestionDef[] = [
  ...
  { id: "Q21", questionFr: "Le terrain est-il à moi avec la maison ?", domain: "legal", engine: "LEGAL", cluster: "D", requiredEvidence: "registre immobilier officiel (tōki)", hardGuardrail: "Jamais supposer la pleine propriété" },
  { id: "Q22", questionFr: "Y a-t-il des héritiers ou un problème de succession ?", domain: "legal", engine: "LEGAL", cluster: "D", requiredEvidence: "registre immobilier officiel + chaîne de droits", hardGuardrail: "Ne pas diagnostiquer un dossier successoral" },
